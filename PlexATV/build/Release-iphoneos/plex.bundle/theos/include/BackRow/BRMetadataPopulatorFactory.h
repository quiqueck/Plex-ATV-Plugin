...
+ (void)setSingleton:(id)singleton;	// 0x32d853e5
+ (id)singleton;	// 0x32d853d9
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x32d85451
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x32d8c981
- (void)dealloc;	// 0x32df3119
- (id)populatorForAsset:(id)asset;	// 0x32d853f1
@end
